                        ...
                        <form className="mt-12 space-y-6">
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    <input name="username" type="text" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" className="w-full text-slate-900 text-sm border border-slate-300 px-4 py-3 pr-8 rounded-md outline-blue-600" placeholder="Enter Email address" onChange={(e) => setEmail(e.target.value)} />
                            ...
                            <div className="!mt-12">
                                <button type="button" className="w-full py-2 px-4 text-[15px] font-medium tracking-wide rounded-md text-white bg-sky-600 hover:bg-sky-800 focus:outline-none cursor-pointer"
                            ...
                            <div className="flex flex-row justify-center items-center">
                                ...
                                <Link to="/singup" className="text-sky-600 hover:text-sky-800 font-semibold ml-2">
                                    Register here
                                </Link>
                            </div>
                        </form>
